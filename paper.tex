...
In diesem Kapitel werden die Umsetzung der Anwendung beschrieben, wobei die Anwendung in eine Serveranwendung (Backend) und eine Webanwendung (Frontend) unterteilt wurde.
\subsection{Backend}
...
\end{center}
\subsubsection[Flughafensuche]{Flughafensuche: GET /airports}\label{sec:airport-search}
...
Liefert das Backend nach Klicken des Suchbuttons Suchergebnisse zurück, lassen sich diese nach bestimmten Airlines filtern, wie an dem Dropdown in Abbildung \ref{fig:frontend} zu sehen ist.\\
