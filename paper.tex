...
In diesem Kapitel werden bekannte Einschränkungen und Fehler der Anwendung aufgelistet, welche nicht gelöst werden konnten, jedoch wird ein Lösungsansatz zum weiteren Vorgehen aufgeführt. Alle Probleme sind in GitHub Issues festgehalten, sodass sie nicht in Vergessenheit geraten können.
...
\subsubsection{Suche mit gemischten Klassen}
